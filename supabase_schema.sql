...
DROP POLICY IF EXISTS "Enable read access for all users" ON telemetry;
DROP POLICY IF EXISTS "Enable insert for all users" ON telemetry;

DROP POLICY IF EXISTS "Enable read access for all users" ON drives;
DROP POLICY IF EXISTS "Enable insert for all users" ON drives;
DROP POLICY IF EXISTS "Enable update for all users" ON drives;

DROP POLICY IF EXISTS "Enable read access for all users" ON charges;
DROP POLICY IF EXISTS "Enable insert for all users" ON charges;
DROP POLICY IF EXISTS "Enable update for all users" ON charges;
